...
#
    ...
    if 0 in scheme:
        output_data_g1, val = GreedyHVF(items, capacity)
        if val >= final_val:
            final_val = val
    ...
    if 1 in scheme:
        output_data_g2, val = GreedySWF(items, capacity)
        if val >= final_val:
            final_val = val
    ...
    if 2 in scheme:
        output_data_g3, val = GreedyHDF(items, capacity)
        if val >= final_val:
            final_val = val
